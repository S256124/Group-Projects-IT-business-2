const RECIPES = [
  {
    ...
    diff: "Easy",
    tags: ["Italian", "Quick"],
    ing: ["Pasta", "Tomater", "Hvidløg", "Chili", "Olivenolie", "Parmesan", "Basilikum"],
    steps: [
  ...
  },
  {
    ...
    ing: ["Æg", "Peberfrugt", "Tomater", "Løg", "Spidskommen", "Paprika"],
    steps:[
  ...
  },
  {
    ...
    diff: "Medium",
    tags: ["Bowl", "Umami"],
    ing: ["Ris", "Spinat", "Gulerod", "Svampe", "Æg", "Gochujang"],
    steps: [
        "Kog risene.",
  ...
  },
  {
    ...
    diff: "Easy",
    tags: ["Lunch", "Comfort"],
    ing: ["Kylling", "Tortillas", "Salat", "Yoghurt", "Paprika"],
    steps: [
  ...
  },
  {
    ...
    diff: "Easy",
    tags: ["Quick", "Protein"],
    ing: ["Laks", "Smør", "Hvidløg", "Citron", "Persille"],
    steps: [
  ...
  },
  {
    ...
    ing: ["Bønner", "Tacoskaller", "Løg", "Lime", "Spidskommen"],
    steps: [
  ...
  },
{
...
},
  {
    ...
    diff: "Medium",
    tags: ["Soup", "Comfort"],
    ing: ["Nudler", "Bouillon", "Soja", "Ingefær", "Æg"],
    steps: [
  ...
  },
  {
    ...
    diff: "Easy",
    tags: ["Dessert", "Quick"],
    ing: ["Mel", "Kakao", "Sukker", "Mælk", "Smør"],
    steps: [
  ...
  },
  {
    ...
    diff: "Easy",
    tags: ["Salad", "Classic"],
    ing: ["Romaine", "Croutoner", "Parmesan", "Hvidløg", "Citron"],
    steps: [
  ...
  },
  {
    ...
    ing: ["Paneer", "Peberfrugt", "Løg", "Yoghurt", "Krydderier"],
    steps: [
  ...
  },
  {
    ...
    ing: ["Havregryn", "Mælk", "Yoghurt", "Bær", "Honning"],
    steps: [
